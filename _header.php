...
<body>
	...
	<nav class="navbar navbar-expand-lg sticky-top navbar-light bg-light shadow">
		<div class="container-fluid container-xl p-2">
			<a class="navbar-brand me-1" href="<?php echo URL; ?>"><img src="<?php echo URL; ?>assets/img/logo-x-p.png" style="width:40px"></a>
			<a href="<?php echo URL; ?>" class="text-decoration-none"><h1 class="fs-1 text-gradient text-primary" style="padding-top:12px;">Contábil.</h1></a>
			<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarScroll" aria-controls="navbarScroll" aria-expanded="false" aria-label="Toggle navigation">
				<span class="navbar-toggler-icon"></span>
			</button>
			<div class="collapse navbar-collapse" id="navbarScroll">
				<ul class="navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;"><li class="nav-item px-2">
					<a class="nav-link" aria-current="page" href="<?php echo URL; ?>">Início</a>
				</li><li class="nav-item px-2">
					<a class="nav-link" aria-current="page" href="<?php echo URL; ?>quem-somos">Quem Somos</a>
				</li>
				<li class="nav-item px-2 dropdown">
					<a class="nav-link dropdown-toggle" href="#" id="navbarScrollingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
						Serviços
					</a>
					<ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown"><li><a class="dropdown-item" href="<?php echo URL; ?>contabilidade-empresarial">Contabilidade Empresarial</a></li><li><a class="dropdown-item" href="<?php echo URL; ?>planejamento-tributario">Planejamento Tributário</a></li><li><a class="dropdown-item" href="<?php echo URL; ?>abertura-de-empresas">Abertura de Empresas</a></li><li><a class="dropdown-item" href="<?php echo URL; ?>folha-de-pagamento">Folha de Pagamento</a></li></ul>
				</li><li class="nav-item px-2">
					<a class="nav-link" aria-current="page" href="<?php echo URL; ?>contato">Contato</a>
				</li></ul>
